...
namespace RPG_003.Battle
{
    ...
    {
        public static DamageInfo MakeDamageInfo(this DamageData data, CharacterObject target, CharacterObject source)
        {
        ...
        public static DamageInfo ResistDamage(this DamageInfo source)
        {
            ...
            // ダメージ耐性による減少
            float resistRate = source.Target.StatusManager.GetStatusAmount(StatusAttribute.DamageResist).ChangedMax;
            ...
            float elemResist = source.Target.StatusManager
                .GetStatusAmount(source.Elements.GetStatusFromElement(false)).ChangedMax;
        ...
        private static bool IsCritical(this DamageData data, CharacterObject source)
        {
            if (data.criticalRate <= 0f) return false;
            var rand = UnityEngine.Random.Range(0f, 1f);
            return rand < data.criticalRate + source.StatusManager.GetStatusAmount(StatusAttribute.CriiticalRate).ChangedMax;
        }
    }
}
